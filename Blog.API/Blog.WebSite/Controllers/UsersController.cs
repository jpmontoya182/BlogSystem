...
namespace Blog.WebSite.Controllers
{
    ...
    {
        private readonly BlogBDContext _context;

        public UsersController(BlogBDContext context)
        {
            _context = context;
        }
        ...
        {
            var blogBDContext = _context.Users.Include(u => u.Profile);
            return View(await blogBDContext.ToListAsync());
        }
        ...
        {
            ViewData["ProfileId"] = new SelectList(_context.Profiles, "ProfileId", "Name");
            return View();
        }
